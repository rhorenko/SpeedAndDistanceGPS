...
public class Provider extends ContentProvider {
    ...
    static {
        ...
        mContactMap.put(DbHelper.LAT, DbHelper.LAT);
        mContactMap.put(DbHelper.LON, DbHelper.LON); 
        mContactMap.put(DbHelper.ALT, DbHelper.ALT);
        mContactMap.put(DbHelper.ACC, DbHelper.ACC);
        mContactMap.put(DbHelper.TIME, DbHelper.TIME);
        }
